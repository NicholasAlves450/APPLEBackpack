...
def on_board_electrolysis(delta_V):

    mass_needed = delta_V * hydrogen_d  # in kilograms
    water_required = mass_needed * 1000 * (1/1.00794) * 2 * 18.02 * (1/1000)  # in liters


    print("Water required to create a change in volume of " + str(delta_V) + " m^3: " + str(water_required) + " liters.")
...
print(str(size_of_balloon(air_d, hydrogen_d, 14) - size_of_balloon(air_d, hydrogen_d, 4)))

on_board_electrolysis(9)
